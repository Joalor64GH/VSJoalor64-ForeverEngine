	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-dead':
				...
				flipX = true;
			case 'joalor64':
				tex = Paths.getSparrowAtlas('characters/Joalor64_lmao');
				frames = tex;
				animation.addByPrefix('idle', "Joalor Idle Dance", 24, false);
				animation.addByPrefix('singUP', 'Joalor Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Joalor Down Note0', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'Joalor NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'Joalor Note Right0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'Joalor Note Right Miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'Joalor NOTE LEFT miss', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'Joalor Note Right0', 24, false);
					animation.addByPrefix('singRIGHT', 'Joalor NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'Joalor NOTE LEFT miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'Joalor Note Right Miss', 24, false);
				}

				animation.addByPrefix('singUPmiss', 'Joalor Up note miss', 24);
				animation.addByPrefix('singDOWNmiss', 'Joalor Down Note MISS', 24);

				playAnim('idle');

				flipX = true;
			case 'ushanka':
				tex = Paths.getSparrowAtlas('characters/Joalor64_ushanka');
				frames = tex;
				animation.addByPrefix('idle', "USHANKA Idle Dance", 24, false);
				animation.addByPrefix('singUP', 'USHANKA Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'USHANKA Down Note0', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'USHANKA NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'USHANKA Note Right0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'USHANKA Note Right Miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'USHANKA NOTE LEFT miss', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'USHANKA Note Right0', 24, false);
					animation.addByPrefix('singRIGHT', 'USHANKA NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'USHANKA NOTE LEFT miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'USHANKA Note Right Miss', 24, false);
				}

				animation.addByPrefix('singUPmiss', 'USHANKA Up note miss', 24);
				animation.addByPrefix('singDOWNmiss', 'USHANKA Down Note MISS', 24);
