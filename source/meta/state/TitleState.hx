...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('menus/base/title/leTitleBG'));
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "VS Joalor64 v1.0.1 (FEL 0.3.1)", 12);
